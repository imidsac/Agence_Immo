...
class OccupationsControllerTest < ActionController::TestCase
  ...
  test "should create occupation" do
    assert_difference('Occupation.count') do
      post :create, occupation: { chamber_id: @occupation.chamber_id, client_id: @occupation.client_id, date_occupation: @occupation.date_occupation, etat: @occupation.etat }
    end
  ...
  test "should update occupation" do
    patch :update, id: @occupation, occupation: { chamber_id: @occupation.chamber_id, client_id: @occupation.client_id, date_occupation: @occupation.date_occupation, etat: @occupation.etat }
    assert_redirected_to occupation_path(assigns(:occupation))
  end
